...
import com.example.org1.service.implementation.*;
...
//    }
    ...
    public ResponseEntity<Object> getPaperHistory(@RequestParam String paperId) throws Exception {
        logger.info("Class: " + this.getClass().getName() + " Function: getMyPaper");

        try {

            return ResponseEntity.status(HttpStatus.OK)
                    .body(chaincodeService.getPaperHistory(paperId));
