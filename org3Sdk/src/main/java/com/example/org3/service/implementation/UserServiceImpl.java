package com.example.org3.service.implementation;

import com.example.org3.model.AppUser;
import com.example.org3.utils.UserGatewayConnection;
...
public class UserServiceImpl {
    ...
    public void addConnection(String userName) throws Exception{
        ...
        Path networkConfigPath = Paths.get( "./../test-network/organizations/peerOrganizations/org3.example.com/connection-org3.yaml");
    ...
    public HFCAClient getCAClient() throws Exception {
        ...
        props.put("pemFile",
                "./../test-network/organizations/peerOrganizations/org3.example.com/ca/ca.org3.example.com-cert.pem");
